...
using Pasquali.Infra.Data.Repository;
using System;
...
namespace Pasquali.MVC
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegistraComponentes()
        {
            ...
            container.RegisterType<ILogAcessoAppService, LogAcessoAppService>();
            container.RegisterType<ILogAcessoRepository, LogAcessoRepository>();
